...
class Hallway(Scene):
    ...
    def enter(self):
        ...
        while True:
            ...
            elif command == "go right" or command == "go right":
                if light == False:
                    print "You right to the right, only to trip over your own", 
                    print "shoelaces. Who doesn't tie their shoes these days?"
                else:
                    print "You go into the eastern room I guess, but that",
                    print "room is still in development, so you're stuck I guess."
